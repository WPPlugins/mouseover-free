...
<div class="wrap">
  <?php 
    ...
    ?>
  <div class="updated-fade-free">Version <?php echo $currentVer; ?> of MouseOver Premium plugin is now available with Much More Features and Options! <a href="http://www.mouseoverplugin.com">Click Here To UPGRADE NOW!</a></div>
  <?php } ?>
  <?php
  ...
  <div class="updated-fade-free">
    <p> <span style="color:#2c7ca7;font-size:15px;font-weight:bold;">Welcome to Mouse Over plugin admin area</span><br>
	  ...
	  <b><span style="color:#2c7ca7;font-size:15px;font-weight:bold;">MouseOver Premium allows you to:</span></b>
...
<span style="color:#2c7ca7;font-size:15px;font-weight:bold;"><a href="http://www.mouseoverplugin.com">Click Here NOW For Additional Features And To Upgrade!</a></span>
    </p>
  </div>
